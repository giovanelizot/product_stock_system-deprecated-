...
<li class="dropdown tasks-menu">
  ...
  <ul class="dropdown-menu">
      <li class="header">Você Tem 4 Tarefas</li>
      <li>
        <!-- menu interno: contém dados -->
        <ul class="menu">
          <li> <!-- Item de Tarefas -->
...
<aside class="main-sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li>
      <a href="src\views\pages\unidades.php">
...
<ul class="treeview-menu">
    <li><a href="src\views\pages\produtos.php"><i class="fa fa-circle-o"></i> Produtos </a></li>
    <li><a href="src\views\pages\marcas.php"><i class="fa fa-circle-o"></i> Marcas </a></li>
    <li><a href="src\views\pages\empresas.php"><i class="fa fa-circle-o"></i> Empresas </a></li>
</ul>
</li>
<li>
  <a href="src\views\pages\pedidos.php">
...
<li>
  <a href="src\views\pages\vendas.php">
...
<li>
    <a href="src\views\pages\fornecedores.php">
...
<li>
    <a href="src\views\pages\relatorios.php">
